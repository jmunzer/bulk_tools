...
function make_resource($shortCode, $title, $resource_type, $isbn, $TalisGUID, $token, $lcn, $web_addresses ) {
...
echo $title."</br>";*/
echo "------------</br>";
$resource_id = make_resource($shortCode, $title, $resource_type, $isbn, $TalisGUID, $token, $lcn, $web_addresses);
